    ...
    <tr>
        <td>
            <form id="main-form" method="get" onsubmit="return validateMainForm(this)">
                ...
                <input type="button" name="value_x" value=3 onclick="setValueX(3)">
                <input type="button" name="value_x" value=4 onclick="setValueX(4)">
                <div class="input" id="xv"
                     style="border-style: solid; width: 10%; text-align: center; border-radius: 45px;">NaN
                </div>
                <div class="input">
                    Введите значение Y:
                </div>
    ...
    <tr>
        <td colspan="2">
            <div style="text-align: center">
                <button type="button" class="button" onclick="clearAnsTable()">Сбросить</button>
            </div>
        </td>
    </tr>
    <tr>
